...
function Home({ addToCart, search, favorites, toggleFavorite }) {
    ...
    return <main className="home-container">
        ...
        <section className="dark-market-band">
            <div className="dark-band-copy"><span>FRANKY GADGET PICKS</span><h2>The phones worth<br/><em>a closer look.</em></h2><p>A curated mix of new releases, popular upgrades and devices customers keep coming back to.</p><Link to="/phones">Explore the collection <span>→</span></Link></div>
        ...
        <section className="market-section">
            <div className="market-head"><div><span>JUST LANDED</span><h2>New arrivals.</h2><p>The latest additions to the Franky Gadget catalogue.</p></div><Link to="/phones">Shop all →</Link></div>
        ...
        <section className="market-benefits">
            <div className="benefit-intro"><span>WHY FRANKY GADGET</span><h2>Everything you need to buy with confidence.</h2></div>
